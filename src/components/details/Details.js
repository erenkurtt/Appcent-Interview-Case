...
const Details = (props) => {
    ...
    useEffect(() => {
        ...
        axios.get(props.Url + "movie/" + id + props.ApiKey + props.langParam).then((data) => {
            setstate(data.data)
         
        })

        axios.get(props.Url + "movie/" + id + "/credits" + props.ApiKey + props.langParam).then((data) => {
                ...
                <div style={{
                    ...
                    <Row className='mainRow'  >
                        ...
                        <Col className='infoSegment' span={18} xs={24} sm={24} md={12} lg={18}>
                            ...
                            {
                                <div>
                                    <span>{state.release_date} ({state.production_countries[0].iso_3166_1})</span>
                                    <span >
                                        {
